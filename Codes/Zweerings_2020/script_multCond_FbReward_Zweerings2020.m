% Define parameters for 1st Level analysis - Feedback Reward - Zweerings 2020
...
n_subj=21;
n_sess=1;
n_runs = 2; % number of runs changes for session in Amano's study
n_valid_trials=9;
nVols = 215;
min_fb_value = 1;
max_fb_value = 99;
...
analysisFolder='D:\Feedback_reward\Analysis\Analysis_Zweerings2020\';

data_file=[analysisFolder filesep 'fbvalues_Zweerings2020.xlsx'];
data_mat=table2cell(readtable(data_file));

onset_file=[analysisFolder filesep 'Zweerings2020_task-nfb_events.csv']; % there are files for each run in Amano's study
