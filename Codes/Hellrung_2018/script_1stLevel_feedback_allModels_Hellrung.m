%%% Run 1st level analysis for all models together for Feedback Appraisal Study - Hellrung data
...
analysisFolder='D:\Feedback_reward\Analysis\Analysis_Hellrung\'; % change this and the next 2 lines
data_folder='D:\Feedback_reward\Data\Data_Hellrung';
mask_file = 'C:\Program Files\MATLAB\R2016a\toolbox\spm12\toolbox\FieldMap\brainmask.nii';
rois_folder = 'D:\Feedback_reward\Analysis\Analysis_Hellrung\rois\';
...
%             n_runs=sum([S(~ismember({S.name},{'.','..'})).isdir]);
            ...
            for run = 1:nruns
                ...
                rpFolder=[subjFolder filesep 'r' num2str(run)];
        ...
        load([analysisFolder 'batch_1stLevel_Feedback_spec_model1_Hellrung.mat'])
        ...
        for sess=1:n_sess
            ...
            for run=1:nruns
                ...
                func_source=[subjFolder filesep 'r' num2str(run)]; % functional images folder
        ...
        matlabbatch{1,1}.spm.stats.fmri_spec.sess.cond(3).onset = vec_count_onset_all;
        matlabbatch{1,1}.spm.stats.fmri_spec.sess.cond(3).duration = vec_count_duration_all;
        matlabbatch{1,1}.spm.stats.fmri_spec.sess.cond(4).onset = vec_fbCount_onset_all;
        matlabbatch{1,1}.spm.stats.fmri_spec.sess.cond(4).duration = vec_fbCount_duration_all;
        ...
        load([analysisFolder 'batch_1stLevel_Feedback_estim_model1_Hellrung.mat'])
        ...
        load([analysisFolder 'batch_createFcontrast_model1_Hellrung.mat'])
        ...
        load([analysisFolder 'batch_1stLevel_Feedback_spec_model2_Hellrung.mat'])
        ...
        matlabbatch{1,1}.spm.stats.fmri_spec.sess.cond(4).onset = vec_count_onset_all;
        matlabbatch{1,1}.spm.stats.fmri_spec.sess.cond(4).duration = vec_count_duration_all;
        matlabbatch{1,1}.spm.stats.fmri_spec.sess.cond(5).onset = vec_fbCount_onset_all;
        matlabbatch{1,1}.spm.stats.fmri_spec.sess.cond(5).duration = vec_fbCount_duration_all;
        ...
        load([analysisFolder 'batch_1stLevel_Feedback_estim_model2_Hellrung.mat'])
        ...
        load([analysisFolder 'batch_createFcontrast_model2_Hellrung.mat'])
        ...
        load([analysisFolder 'batch_createPPI_pmod-base_model3_Hellrung.mat'])
        ...
        load([analysisFolder 'batch_GLM_PPI_FB_pmod_model3_Hellrung.mat'])
        ...
        load([analysisFolder 'batch_createPPI_pmod-base_model4_Hellrung.mat'])
        ...
        load([analysisFolder 'batch_GLM_PPI_FB_pmod_model4_Hellrung.mat'])
