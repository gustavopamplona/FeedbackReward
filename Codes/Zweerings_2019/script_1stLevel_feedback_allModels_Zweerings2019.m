%%% Run 1st level analysis for all models together for Feedback Appraisal Study - Zweerings2019 data
...
analysisFolder='D:\Feedback_reward\Analysis\Analysis_Keller2021\'; % change them
data_folder='D:\Feedback_reward\Data\Data_Keller2021\Model';
...
%     %% Concatenate realignment parameters
    ...
    load([analysisFolder 'batch_1stLevel_Feedback_spec_model1_Zweerings2019.mat'])
    ...
    for sess=1:n_sess
        ...
        for run=1:nruns
            ...
            if length(func_cell_temp{1,1})>210
                func_cell_temp{1,1}(211:end)=[];
            end
...
%     matlabbatch{1,1}.spm.stats.fmri_spec.sess.cond(3).duration = vec_emotion_duration_all; 
    ...
    load([analysisFolder 'batch_1stLevel_Feedback_estim_model1_Zweerings2019.mat'])
    ...
    load([analysisFolder 'batch_createFcontrast_model1_Zweerings2019.mat'])
    ...
    cfg.extent = 0;
    cfg.mask='/machinelearning/apic-n/code/Analysis_Keller2021/ROIs/nAcc_wfu.nii';
    cfg.session = 1;
    ...
    load([analysisFolder 'batch_1stLevel_Feedback_spec_model2_Zweerings2019.mat'])
...
%     matlabbatch{1,1}.spm.stats.fmri_spec.sess.cond(4).duration = vec_emotion_duration_all; 
    ...
    load([analysisFolder 'batch_1stLevel_Feedback_estim_model2_Zweerings2019.mat'])
    ...
    load([analysisFolder 'batch_createFcontrast_model2_Zweerings2019.mat'])
    ...
    cfg.threshdesc = 'none'; % correct for multiple comparisons?
    cfg.extent = 0;
    cfg.mask='/machinelearning/apic-n/code/Analysis_Keller2021/ROIs/mask_dlPFC.nii';
    cfg.session = 1;
    ...
    load([analysisFolder 'batch_createPPI_pmod-base_model3_Zweerings2019.mat'])
    ...
    load([analysisFolder 'batch_GLM_PPI_FB_pmod_model3_Zweerings2019.mat'])
    ...
    load([analysisFolder 'batch_createPPI_pmod-base_model4_Zweerings2019.mat'])
    ...
    load([analysisFolder 'batch_GLM_PPI_FB_pmod_model4_Zweerings2019.mat'])
