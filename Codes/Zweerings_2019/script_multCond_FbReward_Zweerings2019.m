% Define parameters for 1st Level analysis - Feedback Reward - Zweerings 2019
...
analysisFolder='D:\Feedback_reward\Analysis\Analysis_Zweerings2019\';

data_file=[analysisFolder filesep 'fbvalues_Zweerings2019.xlsx'];
data_mat=table2cell(readtable(data_file));

onset_file=[analysisFolder filesep 'Zweerings2019_task-nfb_events.csv']; % there are files for each run in Amano's study
...
%         idx_cell=find([data_mat{:,1}]==subj); % search for indexes of subj and session
        ...
        vec_fb_original=cell2mat(data_mat(idx_cell,5)); % vector of feedback values for specific subj and session
...
%                     if strcmp(onset_cell(i,3),'emotion') % some runs are too short for some Zweerings 2019
...
%         save([data_folder filesep subject_folder(subj).name filesep 'conds_subj0' num2str(subj)],'vec_fb_onset_all','vec_fb_duration_all','vec_fb_value_all',...
        save([analysisFolder filesep 'Cond_files' filesep 'conds_subj0' num2str(subj)],'vec_fb_onset_all','vec_fb_duration_all','vec_fb_value_all',...
            ...
            'vec_reg2after_onset_all','vec_reg2after_duration_all', 'vec_training_onset_all', 'vec_training_duration_all', 'vec_view_onset_all', 'vec_view_duration_all', 'vec_percent_onset_all', 'vec_percent_duration_all')
    else
