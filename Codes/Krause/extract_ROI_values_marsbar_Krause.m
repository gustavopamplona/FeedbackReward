...
addpath('/mnt/fmriprep-hdd0/FeedbackReward/Analysis/Analysis_Krause/marsbar') 

data_folder='/mnt/fmriprep-hdd0/FeedbackReward/Data/DataKrause';
roi_folder = '/mnt/fmriprep-hdd0/FeedbackReward/Analysis/Analysis_Krause/ROIs';
...
%         end
        ...
        Z=[labels;Z];
        xlswrite(['D:\Feedback_reward\Analysis\ROI_analysis\tables\table_model' num2str(model) '_roi' num2str(roi) '_Krause.xlsx'],Z);
